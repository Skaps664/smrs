...
export default function MentorsInvestorsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl shadow-sm border-2 border-orange-200 p-8">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        {/* Current Mentor */}
        {hasMentor && mentor && (
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-lg p-6 mb-4">
        ...
        {!hasMentor && activeMentorInvites.length > 0 && (
          <div className="space-y-3">
            {activeMentorInvites.map((invite) => (
              ...
              >
                <div className="flex-1">
                  <p className="font-medium text-gray-900">Pending Mentor Invite</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        {investors.length > 0 && (
          <div className="space-y-3 mb-6">
            <h3 className="font-semibold text-gray-900">Active Investors ({investors.length})</h3>
            {investors.map((investor) => (
              <div
                key={investor.id}
                className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-lg p-4 flex items-start justify-between"
              >
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">{investor.investor.name}</h4>
                      <p className="text-sm text-gray-600 flex items-center gap-2">
        ...
        {activeInvestorInvites.length > 0 && (
          <div className="space-y-3">
            ...
            {activeInvestorInvites.map((invite) => (
              ...
              >
                <div className="flex-1">
                  <p className="font-medium text-gray-900">Pending Investor Invite</p>
                  <p className="text-sm text-gray-600">
                    Expires: {new Date(invite.expiresAt).toLocaleDateString()}
                  </p>
                </div>
