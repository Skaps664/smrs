      ...
      <div ref={heroTextRef} className="mb-28 max-w-6xl relative z-10">
        <div className="space-y-6 overflow-hidden">
          ...
          <p className="hero-line font-mono text-sm md:text-base text-muted-foreground max-w-3xl leading-relaxed mt-8">
            In the chaos of building something from nothing, founders need clarity, not complexity. eazstart is the operating system for modern startups — combining strategic frameworks, real-time analytics, and collaborative tools into one powerful platform that adapts to your journey from idea to IPO.
          </p>
        </div>
      </div>
      ...
      <div ref={missionRef} className="mb-28 max-w-5xl relative">
        <div className="border-l-4 border-orange-500 pl-8 py-6">
          ...
          <p className="font-mono text-sm md:text-base text-muted-foreground leading-relaxed max-w-3xl">
            ...
            just about the idea — it's about execution, clarity, and having the right tools at the right time. eazstart 
            eliminates friction in the startup journey, letting founders focus on what truly matters: building products 
      ...
      <div ref={footerRef} className="mt-32 pt-16 border-t-2 border-orange-500/20 relative">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-12 mb-12">
          <div className="flex-1">
            ...
            <p className="font-mono text-sm text-muted-foreground max-w-md">
              Join innovative founders who are building the future with eazstart. No credit card required to start.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-8 border-t border-border/30">
          <p className="font-mono text-xs text-muted-foreground">
            © 2025 eazstart. All rights reserved. Empowering startup ecosystems worldwide.
          </p>
