...
export function PrinciplesSectionSMRS() {
  ...
  const principles = [
    {
      ...
      description: "Make informed choices with real-time analytics and insights. Every metric tells a story.",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        { text: "COLLABORATIVE", highlight: true },
        { text: " BY DESIGN", highlight: false },
      ],
      description: "Built for teams. Share progress with stakeholders, mentors, and investors seamlessly.",
      align: "right",
    },
    {
      number: "03",
      ...
      description: "From business model to market research. Clear frameworks for complex challenges.",
      align: "left",
    },
    {
      number: "04",
      ...
      description: "Track milestones, measure KPIs, and scale with confidence. Your success is our mission.",
      align: "right",
    },
  ]
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">OUR APPROACH</h2>
      </div>
