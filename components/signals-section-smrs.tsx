...
const signals = [
  {
    ...
    note: "Comprehensive business model canvas builder with real-time collaboration and strategic framework.",
  },
  {
    date: "2025.12.10",
    title: "Value Proposition Canvas",
    note: "Strategic framework for defining customer segments, pains, gains, and value propositions.",
  },
  {
    date: "2025.12.05",
    title: "MVP Planning & Development",
    note: "Agile planning tools for minimum viable product development with feature prioritization.",
  },
  {
    date: "2025.11.28",
    title: "Market Research Tools",
    note: "Data-driven market insights, competitor analysis, and industry trend tracking.",
  },
  {
    date: "2025.11.20",
    title: "KPI Dashboard & Analytics",
    note: "Real-time metrics, custom KPIs, visual charts, and automated performance reports.",
  },
  {
    date: "2025.11.15",
    title: "And 10+ More Features",
    note: "Weekly trackers, monthly reports, timeline management, document hub, mentor network, investor relations, feedback system, team collaboration, and automated reporting tools.",
  },
]

export function SignalsSectionSMRS() {
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">WHAT&apos;S INCLUDED</h2>
      </div>

      {/* Cards container - wrapping grid instead of horizontal scroll */}
      <div
        ref={(el) => {
          scrollRef.current = el
          cardsRef.current = el
        }}
        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 pr-6 md:pr-12"
      >
